...
# ============================================================================
# Azure Resource Variables (passed via tfvars or merged with JSON)
# ============================================================================
...
# ============================================================================
# Databricks Account Resource Variables
# ============================================================================
...
variable "workspace_admin_assignments" {
  type        = map(any)
  description = "Map of workspace admin assignment configurations"
  default     = {}
}
